...
# Internal imports
from src.manual_model_building.models.regression import linear_polynomial_and_logistic

from src.experiments.line_progression.loss_lines.data.load import (
    gini_index,
    owid_co2,
    un_life_expectancy,
)
...
CURRENT_DIRECTORY = "src/experiments/line_progression/loss_lines"
